...
import "./fonts.css"; // Ensure this contains the necessary Khmer font styles
...
const ProductDeliveryNote = React.forwardRef((props, ref) => {
  ...
  return (
    <div ref={ref} className="p-8 max-w-4xl mx-auto bg-white">
      ...
      <div className="w-full mb-4">
        <table className="w-full border-collapse border border-black">
          ...
          <tbody>
            ...
            {/* If no products are provided, show a placeholder row */}
      ...
      {/* Signature and Transportation Tables */}
      <div className="w-full mb-4">
        <table className="w-full border-collapse border border-black">
          <tbody>
            <tr>
