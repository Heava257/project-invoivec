...
//   <h1 className="text-xl font-bold font-sans">PETRONAS <br /> CAMBODIA</h1>
//     <img
//       src={logo}
//       alt="Company Logo"
...
//           <p className="mt-24 mb-6 khmer-text">ហត្ថលេខា</p>
//           <p className="mt-4 khmer-text">Date: ....../....../.....</p>
//         </div>

//         <div className="text-right mt-20 mb-10 khmer-text">
